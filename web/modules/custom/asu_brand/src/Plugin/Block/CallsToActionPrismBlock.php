...
class CallsToActionPrismBlock extends BlockBase {
  ...
  public function build() {
    ...
    $contact = '<h4>Get in touch</h4><p>Reach out to us if you have questions or concerns about PRISM.</p><br/><br/><div class="row"><div class="col-md-12"><a role="button" class="btn btn-primary" href="/contact">Contact us</a></div></div>';
