...
//    natsort($services);
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $tempstore->set('islandora_repository_reports_report_type', 'published_nodes_by_month');
    $tempstore->set('asu_statistics_generate_csv', $form_state->getValue('asu_statistics_generate_csv'));
    $tempstore->set('asu_statistics_nodes_by_month_collection', $form_state->getValue('nodes_by_month_collection'));
