...
/**
 * Plugin implementation of the 'GeolocationCSVFormatter'.
 *
 * @FieldFormatter(
 *   id = "geolocation_csv",
 *   label = @Translation("Geolocation CSV Formatter"),
 *   field_types = {
 *     "entity_reference_revisions"
 *   }
 * )
 */
class GeolocationCSVFormatter extends EntityReferenceLabelFormatter {
